import { Calendar, Car, GraduationCap, MapPin, Presentation, Users, Zap } from 'lucide-react'
...
const LessonDetails = ({ lesson }: { lesson: Lesson }) => {
  return (
    <div className="max-w-6xl w-full flex-col text-sidebar-foreground mx-auto p-4">
      <Fallback />
      <div className="flex gap-4">
        <div className="group relative w-6/6 transform shadow-2xl rounded-2xl transition-all duration-500">
          <div
        ...
        {lesson?.users?.docs && <LessonCompletedUser users={lesson.users.docs} />}
      </div>
