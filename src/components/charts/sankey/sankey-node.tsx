...
function AnimatedNode({
  ...
  isLeftSide,
  showLabels,
  showValue = true, // ← EKLE (default: true)
}: AnimatedNodeProps) {
  ...
  const currentNameTransition = showNameLabel ? hoverTransition : labelTransition
  const currentValueTransition = showValueLabel ? hoverTransition : labelTransition
      ...
      {nodes.map((node, index) => {
        ...
        return (
          <AnimatedNode
            ...
            showValue={node.category !== 'landing'} // ← BURASI EKLENDİ
            value={displayValue}
            width={nodeWidth}
            x={nodeX}
            y={nodeY}
